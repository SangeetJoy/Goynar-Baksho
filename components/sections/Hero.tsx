...
const styles = {
  ...
  imageWrapper:
    "relative h-[26rem] w-[40rem] overflow-hidden rounded-[2.5rem] shadow-lg",
  image: "object-cover",
  heroLeft: "relative flex justify-end overflow-visible",
  categories: "absolute -bottom-8 left-1/2 -translate-x-8 flex gap-4 z-20",
  heroRight: "flex flex-col items-start gap-8 pl-16", // ✅ no negative margin
  heading: "font-serif text-[3.2rem] leading-tight",
};
...
const HeroRight = () => (
  <div className={styles.heroRight}>
    <h1 className={styles.heading} style={{ color: COLORS.warmEspresso }}>
      Shine without the price
    </h1>
...
export const Hero: React.FC = () => (
  <section className={styles.section} style={{ backgroundColor: COLORS.blush }}>
